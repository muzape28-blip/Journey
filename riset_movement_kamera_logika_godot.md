...
- **Implikasi untuk kita**: urutan benar = (1) karakter berjalan/jog/lari/sprint terasa enak di arena kosong, (2) kamera nyaman di layar 6.7" 720p, (3) baru combat/parry/dodge/peta besar. Placeholder dulu (bahkan kapsul + balok), Shibahu masuk begitu movement terbukti.
...
**Performa**: renderer **Compatibility (GLES 3.0)** (PowerVR GE8320 = GLES3.2/Vulkan1.1 tapi Android Go + GPU entry → Compatibility paling aman); target 30 fps stabil; 720p; draw call < ±100; tekstur ≤1K; grass cards = quad + alpha (sudah kita punyai di GRASS.zip); desert 66.8k tris wajib decimate/pakai sebagian atau ganti lantai GRASS 07_ground.
